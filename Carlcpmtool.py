...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.red_to, '{25}: Change Race Loses        1.000'))
            print(Colorate.Horizontal(Colors., '{26}: Clone Account            7.000'))
            print(Colorate.Horizontal(Colors., '{27}: Custom HP                2.500'))
            print(Colorate.Horizontal(Colors., '{28}: Custom Angle             1.500'))
            print(Colorate.Horizontal(Colors., '{29}: Custom Tire burner       1.500'))
