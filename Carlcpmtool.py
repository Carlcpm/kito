...
pyAnime.Fade(pyCenter.Center(banner), pyColors.blue_to_green, pyColorate.Vertical, enter=True)
...
__CHANNEL_USERNAME__ = "𝘾𝘼𝙍𝙇𝘾𝙋𝙈𝙏𝙊𝙊𝙇=𝐂𝐇𝐀𝐍𝐍𝐄𝐋"
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.blue_to_green, '\t         𝐏𝐋𝐄𝐀𝐒𝐄 𝐋𝐎𝐆𝐎𝐔𝐓 𝐅𝐑𝐎𝐌 𝐂𝐏𝐌 𝐁𝐄𝐅𝐎𝐑𝐄 𝐔𝐒𝐈𝐍𝐆 𝐓𝐇𝐈𝐒 𝐓𝐎𝐎𝐋'))
    print(Colorate.Horizontal(Colors.blue_to_green, '    𝐒𝐇𝐀𝐑𝐈𝐍𝐆 𝐓𝐇𝐄 𝐀𝐂𝐂𝐄𝐒𝐒 𝐊𝐄𝐘 𝐈𝐒 𝐍𝐎𝐓 𝐀𝐋𝐋𝐎𝐖𝐄𝐃 𝐀𝐍𝐃 𝐖𝐈𝐋𝐋 𝐁𝐄 𝐁𝐋𝐎𝐂𝐊𝐄𝐃')) 
    print(Colorate.Horizontal(Colors.blue_to_green, f' ‌           𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: @{__CHANNEL_USERNAME__} 𝐎𝐫 @{__GROUP_USERNAME__}'))
    print(Colorate.Horizontal(Colors.blue_to_green, '==========================================================='))
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:        
            ...
            print(Colorate.Horizontal(Colors.blue_to_green, f'==========[ {__CHANNEL_USERNAME__} ]=========='))
            
            print(Colorate.Horizontal(Colors.blue_to_green, f'Name   : {(data.get("Name") if "Name" in data else "UNDEFINED")}.'))
                
            print(Colorate.Horizontal(Colors.blue_to_green, f'LocalID: {data.get("localID")}.'))
            
            print(Colorate.Horizontal(Colors.blue_to_green, f'Money  : {data.get("money")}.'))
            
            print(Colorate.Horizontal(Colors.blue_to_green, f'Coins  : {data.get("coin")}.'))
            
            friends_count = len(data.get("FriendsID", []))
            print(Colorate.Horizontal(Colors.blue_to_green, f'Friends: {friends_count}.'))
            car_data = data.get("carIDnStatus", {}).get("carGeneratedIDs", [])
            unique_car_data = set(car_data)
            car_count = len(unique_car_data)
            print(Colorate.Horizontal(Colors.blue_to_green, f'Cars   : {car_count}.'))
            
        else:
            print(Colorate.Horizontal(Colors.blue_to_green, '! ERROR: new accounts most be signed-in to the game at least once !.'))
            exit(1)
    else:
        print(Colorate.Horizontal(Colors.blue_to_green, '! ERROR: seems like your login is not properly set !.'))
        exit(1)
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.blue_to_green, f'Access Key : {data.get("access_key")}.'))
    
    print(Colorate.Horizontal(Colors.blue_to_green, f'Telegram ID: {data.get("telegram_id")}.'))
    
    print(Colorate.Horizontal(Colors.blue_to_green, f'Balance    : {(data.get("coins") if not data.get("is_unlimited") else " Unlimited")}.'))
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.blue_to_green, f'==========[ {__CHANNEL_USERNAME__} ]=========='))
    print(Colorate.Horizontal(Colors.blue_to_green, f'Ip Address : {data.get("query")}.'))
    print(Colorate.Horizontal(Colors.blue_to_green, f'Location   : {data.get("city")} {data.get("regionName")} {data.get("countryCode")}.'))
    print(Colorate.Horizontal(Colors.blue_to_green, f'Country    : {data.get("country")} {data.get("zip")}.'))
    print(Colorate.Horizontal(Colors.blue_to_green, f'==========[ {__CHANNEL_USERNAME__} ]=========='))
    ...
    while True:
        ...
        if login_response != 0:
            if login_response == 100:
                ...
                print(Colorate.Horizontal(Colors.blue_to_green, 'WRONG PASSWORD.'))
                sleep(2)
                continue
            elif login_response == 103:
                print(Colorate.Horizontal(Colors.blue_to_green, 'INVALID ACCESS KEY.'))
                sleep(2)
                continue
            else:
                print(Colorate.Horizontal(Colors.blue_to_green, 'TRY AGAIN.'))
                print(Colorate.Horizontal(Colors.blue_to_green, '! Note: make sure you filled out the fields !.'))
                sleep(2)
                continue
        else:
            print(Colorate.Horizontal(Colors.blue_to_green, 'SUCCESSFUL.'))
            sleep(2)
        while True:
            banner(console)
            ...
            print(Colorate.Horizontal(Colors.blue_to_green, '{01}: Modify Money            1.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{02}: Modify Coins            4.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{03}:  Ranking                 8.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{04}: Modify ID                4.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{05}: Change Name              100'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{06}: Change Name (Rainbow)    100'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{07}: Number Plates            2.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{08}: Account Delete           FREE'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{09}: Account Register         FREE'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{10}: Delete Friends           500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{11}: Unlock Paid Cars         5.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{12}: Unlock all Cars          6.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{13}: Unlock all Cars Siren    3.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{14}: Unlock w16 Engine        4.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{15}: Unlock All Horns         3.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{16}: Unlock Disable Damage    3.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{17}: Unlock Unlimited Fuel    3.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{18}: Unlock House 3           4.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{19}: Unlock Smoke             4.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{20}: Unlock Wheels            4.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{21}: Unlock Animations        2.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{22}: Unlock Equipaments M     3.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{23}: Unlock Equipaments F     3.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{24}: Change Race Wins         1.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{25}: Change Race Loses        1.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{26}: Clone Account            7.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{27}: Custom HP                2.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{28}: Custom Angle             1.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{29}: Custom Tire burner       1.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{30}: Custom Car Millage       2.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{31}: Custom Car Brake         2.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{32}: Login Another Account    FREE'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{0} : Exit'))
            ...
            if service == 0: # Exit
                print(Colorate.Horizontal(Colors.blue_to_green, f'Thank You for using our tool, please join our telegram channel: @{__CHANNEL_USERNAME__}.'))
                ...
                if amount > 0 and amount <= 500000000000000000000000000000000:
                    if cpm.set_player_money(amount):
                        ...
                        if answ == "y": print(Colorate.Horizontal(Colors.blue_to_green, f'Thank You for using our tool, please join our telegram channe: @{__CHANNEL_USERNAME__}.'))
                        else: continue
                    else:
                        print(Colorate.Horizontal(Colors.blue_to_green, 'FAILED.'))
                        print(Colorate.Horizontal(Colors.blue_to_green, 'Please try again.'))
                        sleep(2)
                        continue
                else:
                    print(Colorate.Horizontal(Colors.blue_to_green, 'FAILED.'))
                    print(Colorate.Horizontal(Colors.blue_to_green, 'Please use valid values.'))
                    sleep(2)
                    continue
            elif service == 2: # Modify Coins
                print(Colorate.Horizontal(Colors.blue_to_green, '[?] Insert how much coins do you want.'))
                amount = IntPrompt.ask("[?] Amount")
                console.print("[%] Saving your data: ", end=None)
                ...
                if cpm.set_player_rank():
                    ...
                    sleep(2)
                    continue
            elif service == 4: # Modify ID
                print(Colorate.Horizontal(Colors.blue_to_green, '[?] Enter your new ID.'))
                ...
                if len(new_id) >= 0 and len(new_id) <=  and (' ' in new_id) == False:
                    ...
                    print(Colorate.Horizontal(Colors.blue_to_green, 'FAILED.'))
                    print(Colorate.Horizontal(Colors.blue_to_green, 'Please use valid ID.'))
                    sleep(2)
                    continue
            elif service == 5: # Change Name
                print(Colorate.Horizontal(Colors.blue_to_green, '[?] Enter your new Name.'))
