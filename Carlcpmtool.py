...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.green_to_yellow, '{01}: Increase Money           1.500'))
            print(Colorate.Horizontal(Colors.green_to_yellow, '{02}: Increase Coins           4.500'))
            print(Colorate.Horizontal(Colors.green_to_yellow, '{03}: King Rank                8.000'))
            print(Colorate.Horizontal(Colors.green_to_yellow, '{04}: Change ID                4.500'))
            print(Colorate.Horizontal(Colors.green_to_yellow, '{05}: Change Name              100'))
            print(Colorate.Horizontal(Colors.green_to_yellow, '{06}: Change Name (Rainbow)    100'))
            print(Colorate.Horizontal(Colors.green_to_yellow, '{07}: Number Plates            2.000'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{32}: Login Another Account    FREE'))
