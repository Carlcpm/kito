...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.blue_to_blue, f'Balance      : {(data.get("coins") if not data.get("is_unlimited") else " Unlimited")}.'))
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.red_to_yellow, f'==========[ {__CHANNEL_USERNAME__} ]=========='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '{01}: Increase Money           1.500'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{02}: Increase Coins           4.500'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{03}: King Rank                8.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{04}: Change ID                4.500'))
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '{07}: Number Plates            2.000'))
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '{11}: Unlock Paid Cars         5.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{12}: Unlock all Cars          6.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{13}: Unlock all Cars Siren    3.500'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{14}: Unlock w16 Engine        4.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{15}: Unlock All Horns         3.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{16}: Unlock Disable Damage    3.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{17}: Unlock Unlimited Fuel    3.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{18}: Unlock House 3           4.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{19}: Unlock Smoke             4.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{20}: Unlock Wheels            4.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{21}: Unlock Animations        2.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{22}: Unlock Equipaments M     3.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{23}: Unlock Equipaments F     3.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{24}: Change Race Wins         1.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{25}: Change Race Loses        1.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{26}: Clone Account            7.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{27}: Custom HP                2.500'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{28}: Custom Angle             1.500'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{29}: Custom Tire burner       1.500'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{30}: Custom Car Millage       2.000'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '{31}: Custom Car Brake         2.000'))
