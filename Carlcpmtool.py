...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.blue_to_green, '{01}: Increase Money           1.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{02}: Increase Coins           4.500'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{03}: King Rank                8.000'))
            print(Colorate.Horizontal(Colors.blue_to_green, '{04}: Change ID                4.500'))
