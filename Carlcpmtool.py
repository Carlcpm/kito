...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.bold green, f'==========[ {__CHANNEL_USERNAME__} ]=========='))
    print(Colorate.Horizontal(Colors.bold green, f'Ip Address : {data.get("query")}.'))
    print(Colorate.Horizontal(Colors.bold green, f'Location   : {data.get("city")} {data.get("regionName")} {data.get("countryCode")}.'))
    print(Colorate.Horizontal(Colors.bold green, f'Country    : {data.get("country")} {data.get("zip")}.'))
    print(Colorate.Horizontal(Colors.bold green, f'==========[ {__CHANNEL_USERNAME__} ]=========='))
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if cpm.unlock_all_cars():
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.bold green, '======================================'))
                    answ = Prompt.ask("[?] Do You want to Exit ?", choices=["y", "n"], default="n")
                    if answ == "y": print(Colorate.Horizontal(Colors.rainbow, f'Thank You for using our tool, please join our telegram channe: @{__CHANNEL_USERNAME__}.'))
                    else: continue
                else:
                ...
                if cpm.unlock_equipments_female():
                    print(Colorate.Horizontal(Colors.bold green, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    answ = Prompt.ask("[?] Do You want to Exit ?", choices=["y", "n"], default="n")
                    if answ == "y": print(Colorate.Horizontal(Colors.rainbow, f'Thank You for using our tool, please join our telegram channe: @{__CHANNEL_USERNAME__}.'))
                    else: continue
